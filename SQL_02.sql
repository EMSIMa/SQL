...
-- Code 3-2: Querying a subset of columns

SELECT last_name, first_name, salary FROM teachers;

-- Code 3-3: Sorting a column with ORDER BY
...
-- Code 3-4: Sorting multiple columns with ORDER BY

SELECT last_name, school, hire_date
FROM teachers
ORDER BY school ASC, hire_date DESC;

-- Code 3-5: Querying distinct values in the school column

SELECT DISTINCT school
FROM teachers
ORDER BY school;

-- Code 3-6: Querying distinct pairs of values in the school and salary
-- columns
...
-- Code 3-7: Filtering rows using WHERE
...
-- Code 3-8: Filtering with LIKE AND ILIKE
...
-- Code 3-9: Combining operators using AND and OR
...
-- Code 3-10: A SELECT statement including WHERE and ORDER BY
