-- Code 6-1: Creating the departments and employees tables
...
-- Code 6-2: Joining the employees and departments tables
...
-- Code 6-3: Creating two tables to explore JOIN types
...
-- Code 6-8: Using FULL OUTER JOIN
...
-- Code 6-10: Filtering to show missing values with IS NULL
...
-- Code 6-11: Querying specific columns in a join
...
-- Code 6-12: Simplifying code with table aliases
...
-- Code 6-13: Joining multiple tables
...
-- Code 6-14: Combining query results with UNION
...
-- Code 6-15: Combining query results with UNION ALL
...
-- Code 6-16: Customizing a UNION query
...
-- Code 6-17: Combining query results with INTERSECT and EXCEPT
...
-- Code 6-18: Performing math on joined Census population estimates tables
